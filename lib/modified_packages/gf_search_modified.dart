...
class GFSearchBarModified<T> extends StatefulWidget {
  /// search bar with variuos customization option
  const GFSearchBarModified({
...
class MySingleChoiceSearchState<T> extends State<GFSearchBarModified<T>> {
  ...
  @override
  void didUpdateWidget(GFSearchBarModified oldWidget) {
